...
from .views import index_view, post_list_view, post_detail_view, create_post_view, edit_post_view, delete_post_view, portfol_view
...
urlpatterns = [
    ...
    path("portfol", portfol_view, name = 'dportfol')
